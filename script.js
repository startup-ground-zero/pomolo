...
if (sharedFooter) {
  sharedFooter.innerHTML = `
    ...
    <div class="container footer-bottom"><p>&copy; <span id="year"></span> Pomolo Mykonos. All rights reserved. <a href="privacy.html">Privacy</a> <a href="terms.html">Terms</a></p></div>`;
}
