...
if (sharedFooter) {
  sharedFooter.innerHTML = `
    <div class="container footer-inner">
      <div class="footer-brand"><img src="logo.png" alt="Pomolo Mykonos logo" class="brand-logo"><span><span class="brand-rounded-p">ρ</span>OMO<span class="brand-tall-l">l</span>O</span><p>Interior. Luxury. Quality.</p></div>
