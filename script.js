...
if (catalogueViewer) {
  ...
  if (selectedCatalogueCard) {
    const group = selectedCatalogueCard.dataset.categoryGroup;
    if (group) {
      const parentContainer = selectedCatalogueCard.closest('.catalogue-library, .collections');
      if (parentContainer) {
...
if (sharedFooter) {
  sharedFooter.innerHTML = `
    <div class="container footer-inner">
      ...
      <div class="footer-links"><h4>Collections</h4><ul><li><a href="catalogue.html?category=bathroom">Bathroom</a></li><li><a href="catalogue.html?category=tiles">Tiles</a></li><li><a href="catalogue.html?category=furniture">Furniture</a></li><li><a href="catalogue.html?category=curtains">Curtains</a></li></ul></div>
...
const categoryNames = {
  'bathroom': 'Bathroom',
  'furniture': 'Interior & Outdoor Furniture',
  'taps': 'Taps',
